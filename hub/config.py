...
REPO_NAME = os.environ.get("OPENCLAW_HUB_REPO", "mrPDA/vkuswill_bot")
WORKSPACE_REPO_LINK = HOME / ".openclaw" / "workspace-vkuswill" / "repo"
...
DISPATCH_BIN = os.environ.get("OPENCLAW_DISPATCH_BIN", str(HOME / ".local" / "bin" / "oc-dev-dispatch"))
...
HUB_DB_PATH = Path(os.environ.get("OPENCLAW_HUB_DB", str(HOME / ".local" / "state" / "openclaw-hub" / "hub.db")))
...
AUTO_REVIEW_DEFAULT = os.environ.get("OPENCLAW_AUTO_REVIEW", "1") == "1"

ARBITER_RUNTIME = os.environ.get("OPENCLAW_ARBITER_RUNTIME", "openrouter")
ARBITER_AGENT = os.environ.get("OPENCLAW_ARBITER_AGENT", "arbiter")
